...
namespace Labyrinth {
	...
	EditorLayer::EditorLayer()
		:	Layer("EditorLayer"), mCameraController(1280.0f / 720.0f, true), mSquareColour({ 0.2f, 0.3f, 0.8f, 1.0f })
	{
	}
	...
	void EditorLayer::onUpdate(Timestep ts)
	{
...

		{
			...
			Renderer2D::DrawRotatedQuad({ -1.0f, 0.0f }, { 0.8f, 0.8f }, -rotation, mSquareColour);
			Renderer2D::DrawQuad({ 0.5f, -0.5f }, { 0.5f, 0.5f }, mSquareColour);
			Renderer2D::DrawQuad({ -0.5f, -0.5f }, { 0.25f, 0.25f }, mSquareColour);
			Renderer2D::DrawQuad({ 0.75f, 0.75f }, { 0.5f, 0.5f }, mSquareColour);
			Renderer2D::DrawQuad({ 0.0f, 0.0f }, { 0.1f, 0.1f }, mSquareColour);
			Renderer2D::DrawQuad({ 0.0f, 0.0f }, { 1.8f, 1.8f }, mSquareColour);
		...
		if (dockingEnabled)
		{
			...
			if (ImGui::BeginMenuBar())
			{
				if (ImGui::BeginMenu("File"))
				{
					...
					if (ImGui::MenuItem("Exit")) Labyrinth::Application::Get().Close();
					ImGui::EndMenu();
				}
				ImGui::EndMenuBar();
			}
