...
namespace Labyrinth {
	...
	public:
		...
		SubTexture2D(const Ref<Texture2DSheet> sheet, const glm::vec2 coords[4]);
		...
		static Ref<SubTexture2D> CreateFromCoords(const Ref<Texture2DSheet>& tex, const glm::vec2 coords[4]);
